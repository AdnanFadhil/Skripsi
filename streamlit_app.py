...
import pandas as pd  
from backend import generate_stock_predictions,fetch_company_info
...
stock = st.sidebar.selectbox("Choose a stock", df['Security Code'])  
...
historical_data = df[df['Security Code'] == stock]  
