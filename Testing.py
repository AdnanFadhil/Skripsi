...
from another_utils import declare_path, declare_vars, emd_decom_wavelet, get_integration_form, integrate, declare_LSTM_vars, Respective_LSTM_Testing, load_and_preprocess_data, predict_future, evl,plot_direction_accuracy
...
def run():
    ...
    if 'start_date' not in st.session_state:
        st.session_state.start_date = '202`-01-01'
