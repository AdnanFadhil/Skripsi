...
from another_utils2 import declare_path, declare_vars, emd_decom_wavelet, get_integration_form, integrate, declare_LSTM_vars, Respective_LSTM_Testing, load_and_preprocess_data, predict_future, evl,plot_direction_accuracy, analyze_comparison_df
...
def run():
    st.title("📊 Stock Forecasting: AMRT.JK (2021–2025)")
    ...
    st.session_state.ticker = "AMRT.JK"
